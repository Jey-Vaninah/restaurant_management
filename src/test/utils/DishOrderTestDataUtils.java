...
public class DishOrderTestDataUtils {
    public static DishOrder hotDogDishOrder() {
        List<DishOrderStatus> dishOrderStatus = List.of(
            ...
            new DishOrderStatus("DISH-ORDER-STATUS-3", "FIRST-DISH-ORDER-ID", IN_PREPARATION, LocalDateTime.parse("2025-01-01T01:30:00"), LocalDateTime.parse("2025-01-01T01:30:00")),
            new DishOrderStatus("DISH-ORDER-STATUS-2", "FIRST-DISH-ORDER-ID", CONFIRMED, LocalDateTime.parse("2025-01-01T01:00:00"), LocalDateTime.parse("2025-01-01T01:00:00"))
        );
